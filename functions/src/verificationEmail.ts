...
<div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; color: #000;">
  ...
  <p style="text-align: center; font-weight: bold; margin-bottom: 28px;">Please verify your email address to activate your My Baseball Passport account.</p>

  <div style="text-align: center; margin-bottom: 28px;">
    <a href="${verificationLink}" style="background-color: #1a3a6b; color: #ffffff; text-decoration: none; font-weight: bold; padding: 14px 32px; border-radius: 6px; display: inline-block;">Verify Email Address</a>
  </div>
  ...
  <p style="text-align: center; font-weight: bold; margin-bottom: 28px;">If you didn't create this account, you can safely ignore this email.</p>
