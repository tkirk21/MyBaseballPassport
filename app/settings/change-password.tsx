...
export default function ChangePasswordScreen() {
  ...
  const styles = StyleSheet.create({
    ...
    alertMessage:{fontSize:15,color:colorScheme==='dark'?'#F5F1E6':'#374151',textAlign:'center',marginBottom:24,lineHeight:22},
    alertButton:{backgroundColor:colorScheme==='dark'?'#1B3F68':'#E0E7FF',borderWidth:2,borderColor:colorScheme==='dark'?'#4A6FA5':'#2F4F68',paddingVertical:12,paddingHorizontal:32,borderRadius:30},
    ...
    eyeIcon:{padding:16},
    eyeIconColor:{color:colorScheme==='dark'?'#F5F1E6':'#888888'},
    ...
    label:{color:colorScheme==='dark'?'#F5F1E6':'#0A2940',fontSize:16,marginBottom:8},
    passwordContainer:{flexDirection:'row',alignItems:'center',borderWidth:2,borderColor:colorScheme==='dark'?'#4A6FA5':'#2F4F68',borderRadius:8,paddingHorizontal:12,marginBottom:12,backgroundColor:colorScheme==='dark'?'#132F4F':'#FFFFFF'},
    passwordInput:{flex:1,fontSize:16,color:colorScheme==='dark'?'#FFFFFF':'#0A2940',paddingVertical:12},
    passwordPlaceholder:{color:colorScheme==='dark'?'#F5F1E6':'#888888'},
    saveButton:{backgroundColor:colorScheme==='dark'?'#1B3F68':'#FFFFFF',paddingVertical:14,borderRadius:30,borderWidth:2,borderColor:colorScheme==='dark'?'#4A6FA5':'#2F4F68',width:'70%',alignSelf:'center',alignItems:'center'},
