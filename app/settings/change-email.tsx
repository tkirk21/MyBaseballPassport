//baseball//app/settings/change-email.tsx
...
export default function ChangeEmailScreen() {
  ...
  const styles = StyleSheet.create({
    ...
    input:{flex:1,fontSize:16,color:colorScheme==='dark'?'#FFFFFF':'#0A2940',paddingVertical:12,backgroundColor:colorScheme==='dark'?'#132F4F':'#FFFFFF'},
    label:{color:colorScheme==='dark'?'#FFFFFF':'#0A2940',fontSize:16,marginBottom:8},
    newEmailPlaceholder:{color:colorScheme==='dark'?'#F5F1E6':'#888888'},
    passwordContainer:{flexDirection:'row',alignItems:'center',borderWidth:2,borderColor:colorScheme==='dark'?'#B22222':'#2F4F68',borderRadius:8,paddingHorizontal:12,marginBottom:12,backgroundColor:colorScheme==='dark'?'#132F4F':'#FFFFFF'},
