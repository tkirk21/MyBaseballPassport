...
export default function Signup() {
  ...
  const styles = StyleSheet.create({
    ...
    buttonPrimary:{backgroundColor:colorScheme==='dark'?'#243B5A':'#B22222',paddingVertical:16,paddingHorizontal:24,borderRadius:30,borderWidth:2,borderColor:colorScheme==='dark'?'#b22222':'#B22222',marginBottom:20,width:'66%',alignItems:'center',alignSelf:'center',shadowColor:'#000',shadowOffset:{width:0,height:3},shadowOpacity:colorScheme==='dark'?0.5:0.2,shadowRadius:4,elevation:6},
    buttonText:{color:'#F5F1E6',fontSize:18,fontWeight:'600'},
    container:{flex:1,padding:20,justifyContent:'center',backgroundColor:colorScheme==='dark'?'#0D131F':'#F5F1E6'},
    eyeButton:{padding:8},
    eyeIcon:{color:colorScheme==='dark'?'#AFC7E6':'#1D3557',fontSize:22},
    ...
    input:{height:50,borderColor:colorScheme==='dark'?'#b22222':'#B22222',borderWidth:1,paddingHorizontal:12,marginBottom:16,borderRadius:6,fontSize:16,color:colorScheme==='dark'?'#FFFFFF':'#1D3557',backgroundColor:colorScheme==='dark'?'#243B5A':'#FFFFFF'},
    keyboardWrapper:{flex:1},
    passwordContainer:{flexDirection:'row',alignItems:'center',borderWidth:1,borderColor:colorScheme==='dark'?'#b22222':'#B22222',borderRadius:6,height:50,marginBottom:16,paddingRight:12,backgroundColor:colorScheme==='dark'?'#243B5A':'#FFFFFF'},
    passwordInput:{flex:1,height:50,paddingHorizontal:12,fontSize:16,color:colorScheme==='dark'?'#FFFFFF':'#1D3557',backgroundColor:'transparent'},
    ...
    title:{fontSize:26,fontWeight:'bold',color:colorScheme==='dark'?'#F5F1E6':'#1D3557',marginBottom:24,textAlign:'center'},
    toggle:{marginTop:16,alignItems:'center'},
    toggleText:{color:colorScheme==='dark'?'#ffffff':'#1D3557',fontWeight:'500'},
