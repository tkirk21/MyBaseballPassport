...
export default function MapScreen() {
  ...
  const styles = StyleSheet.create({
    ...
    upgradeButtonText: { color: '#FFFFFF', fontSize: 18, fontWeight: 'bold' },
    upgradeTitle: { fontSize: 24, fontWeight: 'bold', color: colorScheme === 'dark' ? '#FFFFFF' : '#0A2940', textAlign: 'center', marginBottom: 20 },
    upgradeSubtext: { fontSize: 18, color: colorScheme === 'dark' ? '#CCCCCC' : '#374151', textAlign: 'center', marginBottom: 30, paddingHorizontal: 20 },
  });
